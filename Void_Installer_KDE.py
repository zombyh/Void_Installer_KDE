...
while True:
    ...
    if choice == '1':  # Instalar ambiente Plasma/KDE
        ...
        os.system("xbps-install -Suy")
        os.system("chsh -s /bin/bash ; sudo su")
        os.system("xbps-install -yf nano inetutils-ifconfig cmake git cppcheck indent colord-kde flatpak-kcm gwenview kdegraphics-thumbnailers kdewebkit krename ksolid kwrite void-updates vpnd plasma-desktop xorg base-devel kde5 kde5-baseapps firefox wireplumber  colord preload gimp vlc papirus-icon-theme unrar p7zip ntfs-3g ark kcalc ntp libreoffice aspell-pt_BR firefox-i18n-pt-BR hunspell-pt_BR libreoffice-i18n-pt-BR manpages-pt-br git xtools okular wget spectacle screenFetch openjdk curl xz unzip gptfdisk mtools mlocate fuse-exfat bash-completion linux-headers ffmpeg htop autoconf automake bison m4 make libtool flex meson ninja optipng sassc cronie partitionmanager")
