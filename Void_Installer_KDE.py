...
def configure_plasma():
    packages = "void-repo-nonfree nano qbittorrent ruby nodejs vscode wireless_tools inetutils-ifconfig pipewire pulseaudio cmake git cppcheck indent colord-kde flatpak-kcm gwenview kdegraphics-thumbnailers kdewebkit krename ksolid kwrite void-updates vpnd plasma-desktop xorg base-devel kde5 kde5-baseapps plasma-browser-integration firefox-esr wireplumber colord preload gimp vlc papirus-icon-theme p7zip ntfs-3g ark kcalc ntp libreoffice aspell-pt_BR firefox-esr-i18n-pt-BR hunspell-pt_BR libreoffice-i18n-pt-BR manpages-pt-br git xtools okular wget spectacle screenFetch openjdk curl xz unzip gptfdisk mtools mlocate fuse-exfat bash-completion linux-headers ffmpeg htop autoconf automake bison curl m4 make libtool flex meson ninja optipng sassc cronie partitionmanager python3-pip gst-plugins-base1 gst-plugins-good1 gst-plugins-bad1 gst-plugins-ugly1"
